				...
				// Skel.
					skel.init({
						...
						breakpoints: {
							...
							desktop: { range: '737-', href: themepath + 'css/style-desktop.css', viewport: { width: 1280, scalable: false } },
							mobile: { range: '-736', href: themepath + 'css/style-mobile.css', viewport: { scalable: false } }
						}
					});
